// WorkFinder — home.js (Feed de vagas reais via API)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const el = document.getElementById('nav-nome'); if (el) el.textContent = nome;
    const av = document.getElementById('nav-avatar'); if (av) av.textContent = iniciais(nome);
    carregarVagas();
