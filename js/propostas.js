// WorkFinder — propostas.js (Propostas reais via API)
      ...
      <div class="prop-card ${p.status}" onclick="abrirDetalhe(${p.id})">
        ...
        <div class="prop-footer">
          <div class="prop-meta">
            ...
            <span class="prop-info">⏱ ${p.prazo_proposto ? p.prazo_proposto + ' dias' : '–'}</span>
...
function abrirDetalhe(id) {
    ...
    document.getElementById('detail-rows').innerHTML = [
        ...
        ['Prazo', propostaSel.prazo_proposto ? propostaSel.prazo_proposto + ' dias' : '–'],
